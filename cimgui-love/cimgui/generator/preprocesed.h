...
struct ImBitArray
{
    ...
    bool TestBit(int n) const {                                                  ((void) sizeof ((                                                 n + OFFSET < BITCOUNT                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n + OFFSET < BITCOUNT                                                 ) ; else __assert_fail (                                                 "n + OFFSET < BITCOUNT"                                                 , "../imgui/imgui_internal.h", 562, __extension__ __PRETTY_FUNCTION__); }))                                                                                 ; return ImBitArrayTestBit(Storage, n + OFFSET); }
    void SetBit(int n) {                                                  ((void) sizeof ((                                                 n + OFFSET < BITCOUNT                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n + OFFSET < BITCOUNT                                                 ) ; else __assert_fail (                                                 "n + OFFSET < BITCOUNT"                                                 , "../imgui/imgui_internal.h", 563, __extension__ __PRETTY_FUNCTION__); }))                                                                                 ; ImBitArraySetBit(Storage, n + OFFSET); }
    void ClearBit(int n) {                                                  ((void) sizeof ((                                                 n + OFFSET < BITCOUNT                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n + OFFSET < BITCOUNT                                                 ) ; else __assert_fail (                                                 "n + OFFSET < BITCOUNT"                                                 , "../imgui/imgui_internal.h", 564, __extension__ __PRETTY_FUNCTION__); }))                                                                                 ; ImBitArrayClearBit(Storage, n + OFFSET); }
    void SetBitRange(int n, int n2) { ImBitArraySetBitRange(Storage, n + OFFSET, n2 + OFFSET); }
    bool operator[](int n) const {                                                  ((void) sizeof ((                                                 n + OFFSET < BITCOUNT                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n + OFFSET < BITCOUNT                                                 ) ; else __assert_fail (                                                 "n + OFFSET < BITCOUNT"                                                 , "../imgui/imgui_internal.h", 566, __extension__ __PRETTY_FUNCTION__); }))                                                                                 ; return ImBitArrayTestBit(Storage, n + OFFSET); }
};
struct ImBitVector
{
    ...
    bool TestBit(int n) const {                                                  ((void) sizeof ((                                                 n < (Storage.Size << 5)                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n < (Storage.Size << 5)                                                 ) ; else __assert_fail (                                                 "n < (Storage.Size << 5)"                                                 , "../imgui/imgui_internal.h", 576, __extension__ __PRETTY_FUNCTION__); }))                                                                                   ; return ImBitArrayTestBit(Storage.Data, n); }
    void SetBit(int n) {                                                  ((void) sizeof ((                                                 n < (Storage.Size << 5)                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n < (Storage.Size << 5)                                                 ) ; else __assert_fail (                                                 "n < (Storage.Size << 5)"                                                 , "../imgui/imgui_internal.h", 577, __extension__ __PRETTY_FUNCTION__); }))                                                                                   ; ImBitArraySetBit(Storage.Data, n); }
    void ClearBit(int n) {                                                  ((void) sizeof ((                                                 n < (Storage.Size << 5)                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n < (Storage.Size << 5)                                                 ) ; else __assert_fail (                                                 "n < (Storage.Size << 5)"                                                 , "../imgui/imgui_internal.h", 578, __extension__ __PRETTY_FUNCTION__); }))                                                                                   ; ImBitArrayClearBit(Storage.Data, n); }
};
template<typename T>
struct ImSpan
{
    ...
    inline T& operator[](int i) { T* p = Data + i;                                                                       ((void) sizeof ((                                                                      p >= Data && p < DataEnd                                                                      ) ? 1 : 0), __extension__ ({ if (                                                                      p >= Data && p < DataEnd                                                                      ) ; else __assert_fail (                                                                      "p >= Data && p < DataEnd"                                                                      , "../imgui/imgui_internal.h", 598, __extension__ __PRETTY_FUNCTION__); }))                                                                                                         ; return *p; }
    inline const T& operator[](int i) const { const T* p = Data + i;                                                                             ((void) sizeof ((                                                                            p >= Data && p < DataEnd                                                                            ) ? 1 : 0), __extension__ ({ if (                                                                            p >= Data && p < DataEnd                                                                            ) ; else __assert_fail (                                                                            "p >= Data && p < DataEnd"                                                                            , "../imgui/imgui_internal.h", 599, __extension__ __PRETTY_FUNCTION__); }))                                                                                                               ; return *p; }
    inline T* begin() { return Data; }
    inline const T* begin() const { return Data; }
    inline T* end() { return DataEnd; }
    inline const T* end() const { return DataEnd; }
    inline int index_from_ptr(const T* it) const {                                                      ((void) sizeof ((                                                     it >= Data && it < DataEnd                                                     ) ? 1 : 0), __extension__ ({ if (                                                     it >= Data && it < DataEnd                                                     ) ; else __assert_fail (                                                     "it >= Data && it < DataEnd"                                                     , "../imgui/imgui_internal.h", 607, __extension__ __PRETTY_FUNCTION__); }))                                                                                          ; const ptrdiff_t off = it - Data; return (int)off; }
};
template<int CHUNKS>
struct ImSpanAllocator
{
    ...
    inline void Reserve(int n, size_t sz, int a=4) {                                                      ((void) sizeof ((                                                     n == CurrIdx && n < CHUNKS                                                     ) ? 1 : 0), __extension__ ({ if (                                                     n == CurrIdx && n < CHUNKS                                                     ) ; else __assert_fail (                                                     "n == CurrIdx && n < CHUNKS"                                                     , "../imgui/imgui_internal.h", 623, __extension__ __PRETTY_FUNCTION__); }))                                                                                          ; CurrOff = (((CurrOff) + (a - 1)) & ~(a - 1)); Offsets[n] = CurrOff; Sizes[n] = (int)sz; CurrIdx++; CurrOff += (int)sz; }
    inline int GetArenaSizeInBytes() { return CurrOff; }
    inline void SetArenaBasePtr(void* base_ptr) { BasePtr = (char*)base_ptr; }
    inline void* GetSpanPtrBegin(int n) {                                                      ((void) sizeof ((                                                     n >= 0 && n < CHUNKS && CurrIdx == CHUNKS                                                     ) ? 1 : 0), __extension__ ({ if (                                                     n >= 0 && n < CHUNKS && CurrIdx == CHUNKS                                                     ) ; else __assert_fail (                                                     "n >= 0 && n < CHUNKS && CurrIdx == CHUNKS"                                                     , "../imgui/imgui_internal.h", 626, __extension__ __PRETTY_FUNCTION__); }))                                                                                                         ; return (void*)(BasePtr + Offsets[n]); }
    inline void* GetSpanPtrEnd(int n) {                                                      ((void) sizeof ((                                                     n >= 0 && n < CHUNKS && CurrIdx == CHUNKS                                                     ) ? 1 : 0), __extension__ ({ if (                                                     n >= 0 && n < CHUNKS && CurrIdx == CHUNKS                                                     ) ; else __assert_fail (                                                     "n >= 0 && n < CHUNKS && CurrIdx == CHUNKS"                                                     , "../imgui/imgui_internal.h", 627, __extension__ __PRETTY_FUNCTION__); }))                                                                                                         ; return (void*)(BasePtr + Offsets[n] + Sizes[n]); }
    template<typename T>
...
struct ImPool
{
    ...
    ImPoolIdx GetIndex(const T* p) const {                                                      ((void) sizeof ((                                                     p >= Buf.Data && p < Buf.Data + Buf.Size                                                     ) ? 1 : 0), __extension__ ({ if (                                                     p >= Buf.Data && p < Buf.Data + Buf.Size                                                     ) ; else __assert_fail (                                                     "p >= Buf.Data && p < Buf.Data + Buf.Size"                                                     , "../imgui/imgui_internal.h", 648, __extension__ __PRETTY_FUNCTION__); }))                                                                                                        ; return (ImPoolIdx)(p - Buf.Data); }
...
struct ImChunkStream
{
    ...
    T* next_chunk(T* p) { size_t HDR_SZ = 4;                                                             ((void) sizeof ((                                                            p >= begin() && p < end()                                                            ) ? 1 : 0), __extension__ ({ if (                                                            p >= begin() && p < end()                                                            ) ; else __assert_fail (                                                            "p >= begin() && p < end()"                                                            , "../imgui/imgui_internal.h", 683, __extension__ __PRETTY_FUNCTION__); }))                                                                                                ; p = (T*)(void*)((char*)(void*)p + chunk_size(p)); if (p == (T*)(void*)((char*)end() + HDR_SZ)) return (T*)0;                                                                                                                                                                                                                ((void) sizeof ((                                                                                                                                                                                                               p < end()                                                                                                                                                                                                               ) ? 1 : 0), __extension__ ({ if (                                                                                                                                                                                                               p < end()                                                                                                                                                                                                               ) ; else __assert_fail (                                                                                                                                                                                                               "p < end()"                                                                                                                                                                                                               , "../imgui/imgui_internal.h", 683, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                                                                                                                                   ; return p; }
    int chunk_size(const T* p) { return ((const int*)p)[-1]; }
    T* end() { return (T*)(void*)(Buf.Data + Buf.Size); }
    int offset_from_ptr(const T* p) {                                          ((void) sizeof ((                                         p >= begin() && p < end()                                         ) ? 1 : 0), __extension__ ({ if (                                         p >= begin() && p < end()                                         ) ; else __assert_fail (                                         "p >= begin() && p < end()"                                         , "../imgui/imgui_internal.h", 686, __extension__ __PRETTY_FUNCTION__); }))                                                                             ; const ptrdiff_t off = (const char*)p - Buf.Data; return (int)off; }
    T* ptr_from_offset(int off) {                                          ((void) sizeof ((                                         off >= 4 && off < Buf.Size                                         ) ? 1 : 0), __extension__ ({ if (                                         off >= 4 && off < Buf.Size                                         ) ; else __assert_fail (                                         "off >= 4 && off < Buf.Size"                                         , "../imgui/imgui_internal.h", 687, __extension__ __PRETTY_FUNCTION__); }))                                                                              ; return (T*)(void*)(Buf.Data + off); }
...
struct ImGuiNavItemData
{
    ...
    void Clear() { Window =                                   ((void *)0)                                      ; ID = FocusScopeId = 0; InFlags = 0; DistBox = DistCenter = DistAxial = 3.40282346638528859811704183484516925e+38F; }
};
...
struct ImGuiViewportP : public ImGuiViewport
{
    ...
    ImGuiViewportP() { Idx = -1; LastFrameActive = DrawListsLastFrame[0] = DrawListsLastFrame[1] = LastFrontMostStampCount = -1; LastNameHash = 0; Alpha = LastAlpha = 1.0f; PlatformMonitor = -1; PlatformWindowCreated = false; Window =                                                                                                                                                                                                                                                              ((void *)0)                                                                                                                                                                                                                                                                 ; DrawLists[0] = DrawLists[1] =                                                                                                                                                                                                                                                                                                  ((void *)0)                                                                                                                                                                                                                                                                                                     ; LastPlatformPos = LastPlatformSize = LastRendererSize = ImVec2(3.40282346638528859811704183484516925e+38F, 3.40282346638528859811704183484516925e+38F); }
...
public:
    ...
    ImGuiID GetID(int n);
    ImGuiID GetIDNoKeepAlive(const char* str, const char* str_end =                                                                        ((void *)0)                                                                           );
...
struct ImGuiTabBar
{
    ...
    const char* GetTabName(const ImGuiTabItem* tab) const
    {
       ...
       ((void) sizeof ((       tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size       ) ? 1 : 0), __extension__ ({ if (       tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size       ) ; else __assert_fail (       "tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size"       , "../imgui/imgui_internal.h", 2435, __extension__ __PRETTY_FUNCTION__); }))                                                                               ;
...
namespace ImGui
{
    ...
    inline bool IsKeyPressedMap(ImGuiKey key, bool repeat = true) {                                                                                          ((void) sizeof ((                                                                                         IsNamedKey(key)                                                                                         ) ? 1 : 0), __extension__ ({ if (                                                                                         IsNamedKey(key)                                                                                         ) ; else __assert_fail (                                                                                         "IsNamedKey(key)"                                                                                         , "../imgui/imgui_internal.h", 2904, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                   ; return IsKeyPressed(key, repeat); }
    ...
    inline ImGuiInputTextState* GetInputTextState(ImGuiID id) { ImGuiContext& g = *GImGui; return (g.InputTextState.ID == id) ? &g.InputTextState :                                                                                                                                                      ((void *)0)                                                                                                                                                         ; }
