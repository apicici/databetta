...
ImDrawDataBuilder["Clear"] = ImDrawDataBuilder["Clear"]  or function(i1)
    jit.off(true)
    local out = C.ImDrawDataBuilder_Clear(i1)
    return out
end
ImDrawDataBuilder["ClearFreeMemory"] = ImDrawDataBuilder["ClearFreeMemory"]  or function(i1)
    jit.off(true)
    local out = C.ImDrawDataBuilder_ClearFreeMemory(i1)
    return out
end
ImDrawDataBuilder["FlattenIntoSingleLayer"] = ImDrawDataBuilder["FlattenIntoSingleLayer"]  or function(i1)
    jit.off(true)
    local out = C.ImDrawDataBuilder_FlattenIntoSingleLayer(i1)
    return out
end
ImDrawDataBuilder["GetDrawListCount"] = ImDrawDataBuilder["GetDrawListCount"]  or function(i1)
    jit.off(true)
    local out = C.ImDrawDataBuilder_GetDrawListCount(i1)
    return out
end
...
ImGuiDockNode["Rect"] = ImGuiDockNode["Rect"]  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.ImGuiDockNode_Rect(o1, i1)
    return o1[0], out
end
...
local ImGuiMetricsConfig = ImGuiMetricsConfig or {}
ImGuiMetricsConfig.__index = ImGuiMetricsConfig
local mt = getmetatable(ImGuiMetricsConfig) or {}
mt.__call = mt.__call or function(self)
    jit.off(true)
    local p = C.ImGuiMetricsConfig_ImGuiMetricsConfig()
    return ffi.gc(p[0], C.ImGuiMetricsConfig_destroy)
end
setmetatable(ImGuiMetricsConfig, mt)
M.ImGuiMetricsConfig = ImGuiMetricsConfig
ffi.metatype("ImGuiMetricsConfig", ImGuiMetricsConfig)
...
ImGuiStackSizes["CompareWithCurrentState"] = ImGuiStackSizes["CompareWithCurrentState"]  or function(i1)
    jit.off(true)
    local out = C.ImGuiStackSizes_CompareWithCurrentState(i1)
    return out
end
ImGuiStackSizes["SetToCurrentState"] = ImGuiStackSizes["SetToCurrentState"]  or function(i1)
    jit.off(true)
    local out = C.ImGuiStackSizes_SetToCurrentState(i1)
    return out
end
...
local ImGuiStackTool = ImGuiStackTool or {}
ImGuiStackTool.__index = ImGuiStackTool
local mt = getmetatable(ImGuiStackTool) or {}
mt.__call = mt.__call or function(self)
    jit.off(true)
    local p = C.ImGuiStackTool_ImGuiStackTool()
    return ffi.gc(p[0], C.ImGuiStackTool_destroy)
end
setmetatable(ImGuiStackTool, mt)
M.ImGuiStackTool = ImGuiStackTool
ffi.metatype("ImGuiStackTool", ImGuiStackTool)
...
ImGuiTabBar["GetTabName"] = ImGuiTabBar["GetTabName"]  or function(i1, i2)
    jit.off(true)
    local out = C.ImGuiTabBar_GetTabName(i1, i2)
    return out
end
ImGuiTabBar["GetTabOrder"] = ImGuiTabBar["GetTabOrder"]  or function(i1, i2)
    jit.off(true)
    local out = C.ImGuiTabBar_GetTabOrder(i1, i2)
    return out
end
...
ImGuiViewportP["GetBuildWorkRect"] = ImGuiViewportP["GetBuildWorkRect"]  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.ImGuiViewportP_GetBuildWorkRect(o1, i1)
    return o1[0], out
end
ImGuiViewportP["GetMainRect"] = ImGuiViewportP["GetMainRect"]  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.ImGuiViewportP_GetMainRect(o1, i1)
    return o1[0], out
end
ImGuiViewportP["GetWorkRect"] = ImGuiViewportP["GetWorkRect"]  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.ImGuiViewportP_GetWorkRect(o1, i1)
    return o1[0], out
end
...
ImGuiWindow["GetIDNoKeepAlive_Str"] = ImGuiWindow["GetIDNoKeepAlive_Str"]  or function(i1, i2, i3)
    jit.off(true)
    local out = C.ImGuiWindow_GetIDNoKeepAlive_Str(i1, i2, i3)
    return out
end
ImGuiWindow["GetIDNoKeepAlive_Ptr"] = ImGuiWindow["GetIDNoKeepAlive_Ptr"]  or function(i1, i2)
    jit.off(true)
    local out = C.ImGuiWindow_GetIDNoKeepAlive_Ptr(i1, i2)
    return out
end
ImGuiWindow["GetIDNoKeepAlive_Int"] = ImGuiWindow["GetIDNoKeepAlive_Int"]  or function(i1, i2)
    jit.off(true)
    local out = C.ImGuiWindow_GetIDNoKeepAlive_Int(i1, i2)
    return out
end
ImGuiWindow["MenuBarHeight"] = ImGuiWindow["MenuBarHeight"]  or function(i1)
    jit.off(true)
    local out = C.ImGuiWindow_MenuBarHeight(i1)
    return out
end
ImGuiWindow["MenuBarRect"] = ImGuiWindow["MenuBarRect"]  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.ImGuiWindow_MenuBarRect(o1, i1)
    return o1[0], out
end
ImGuiWindow["Rect"] = ImGuiWindow["Rect"]  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.ImGuiWindow_Rect(o1, i1)
    return o1[0], out
end
ImGuiWindow["TitleBarHeight"] = ImGuiWindow["TitleBarHeight"]  or function(i1)
    jit.off(true)
    local out = C.ImGuiWindow_TitleBarHeight(i1)
    return out
end
ImGuiWindow["TitleBarRect"] = ImGuiWindow["TitleBarRect"]  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.ImGuiWindow_TitleBarRect(o1, i1)
    return o1[0], out
end
...
M.ActivateItem = M.ActivateItem  or function(i1)
    jit.off(true)
    local out = C.igActivateItem(i1)
    return out
end
...
M.BeginTabBarEx = M.BeginTabBarEx  or function(i1, i2, i3, i4)
    jit.off(true)
    local out = C.igBeginTabBarEx(i1, i2, i3, i4)
    return out
end
...
M.ButtonBehavior = M.ButtonBehavior  or function(i1, i2, i3)
    jit.off(true)
    if i3 == nil then i3 = 0 end
    local o1 = ffi.new("bool[1]")
    local o2 = ffi.new("bool[1]")
    local out = C.igButtonBehavior(i1, i2, o1, o2, i3)
    return o1[0], o2[0], out
end
...
M.DataTypeApplyFromText = M.DataTypeApplyFromText  or function(i1, i2, i3, i4)
    jit.off(true)
    local out = C.igDataTypeApplyFromText(i1, i2, i3, i4)
    return out
end
...
M.DebugNodeDrawCmdShowMeshAndBoundingBox = M.DebugNodeDrawCmdShowMeshAndBoundingBox  or function(i1, i2, i3, i4)
    jit.off(true)
    local o1 = ffi.new("ImDrawList[1]")
    local out = C.igDebugNodeDrawCmdShowMeshAndBoundingBox(o1, i1, i2, i3, i4)
    return o1[0], out
end
...
M.DockBuilderCopyNode = M.DockBuilderCopyNode  or function(i1, i2)
    jit.off(true)
    local o1 = ffi.new("ImVector_ImGuiID[1]")
    local out = C.igDockBuilderCopyNode(i1, i2, o1)
    return o1[0], out
end
...
M.DockBuilderSplitNode = M.DockBuilderSplitNode  or function(i1, i2, i3)
    jit.off(true)
    local o1 = ffi.new("ImGuiID[1]")
    local o2 = ffi.new("ImGuiID[1]")
    local out = C.igDockBuilderSplitNode(i1, i2, i3, o1, o2)
    return o1[0], o2[0], out
end
M.DockContextCalcDropPosForDocking = M.DockContextCalcDropPosForDocking  or function(i1, i2, i3, i4, i5)
    jit.off(true)
    local o1 = ffi.new("ImVec2[1]")
    local out = C.igDockContextCalcDropPosForDocking(i1, i2, i3, i4, i5, o1)
    return o1[0], out
end
...
M.FindOrCreateWindowSettings = M.FindOrCreateWindowSettings  or function(i1)
    jit.off(true)
    local out = C.igFindOrCreateWindowSettings(i1)
    return out
end
...
M.FindWindowSettings = M.FindWindowSettings  or function(i1)
    jit.off(true)
    local out = C.igFindWindowSettings(i1)
    return out
end
M.FocusTopMostWindowUnderOne = M.FocusTopMostWindowUnderOne  or function(i1, i2)
    jit.off(true)
    local out = C.igFocusTopMostWindowUnderOne(i1, i2)
    return out
end
M.FocusWindow = M.FocusWindow  or function(i1)
    jit.off(true)
    local out = C.igFocusWindow(i1)
    return out
end
...
M.GetFocusScope = M.GetFocusScope  or function()
    jit.off(true)
    local out = C.igGetFocusScope()
    return out
end
M.GetFocusedFocusScope = M.GetFocusedFocusScope  or function()
    jit.off(true)
    local out = C.igGetFocusedFocusScope()
    return out
end
...
M.GetIDWithSeed = M.GetIDWithSeed  or function(i1, i2, i3)
    jit.off(true)
    local out = C.igGetIDWithSeed(i1, i2, i3)
    return out
end
...
M.GetKeyData = M.GetKeyData  or function(i1)
    jit.off(true)
    local out = C.igGetKeyData(i1)
    return out
end
...
M.GetMergedKeyModFlags = M.GetMergedKeyModFlags  or function()
    jit.off(true)
    local out = C.igGetMergedKeyModFlags()
    return out
end
...
M.GetNavInputAmount = M.GetNavInputAmount  or function(i1, i2)
    jit.off(true)
    local out = C.igGetNavInputAmount(i1, i2)
    return out
end
M.GetNavInputAmount2d = M.GetNavInputAmount2d  or function(i1, i2, i3, i4)
    jit.off(true)
    if i3 == nil then i3 = 0.0 end
    if i4 == nil then i4 = 0.0 end
    local o1 = ffi.new("ImVec2[1]")
    local out = C.igGetNavInputAmount2d(o1, i1, i2, i3, i4)
    return o1[0], out
end
M.GetNavInputName = M.GetNavInputName  or function(i1)
    jit.off(true)
    local out = C.igGetNavInputName(i1)
    return out
end
...
M.GetPopupAllowedExtentRect = M.GetPopupAllowedExtentRect  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.igGetPopupAllowedExtentRect(o1, i1)
    return o1[0], out
end
...
M.GetWindowScrollbarRect = M.GetWindowScrollbarRect  or function(i1, i2)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.igGetWindowScrollbarRect(o1, i1, i2)
    return o1[0], out
end
...
M.ImFloorSigned_Float = M.ImFloorSigned_Float  or function(i1)
    jit.off(true)
    local out = C.igImFloorSigned_Float(i1)
    return out
end
M.ImFloorSigned_Vec2 = M.ImFloorSigned_Vec2  or function(i1)
    jit.off(true)
    local o1 = ffi.new("ImVec2[1]")
    local out = C.igImFloorSigned_Vec2(o1, i1)
    return o1[0], out
end
...
M.ImFontAtlasBuildMultiplyCalcLookupTable = M.ImFontAtlasBuildMultiplyCalcLookupTable  or function(i1)
    jit.off(true)
    local o1 = ffi.new("unsigned char[256][1]")
    local out = C.igImFontAtlasBuildMultiplyCalcLookupTable(o1, i1)
    return o1[0], out
end
...
M.ImGetDirQuadrantFromDelta = M.ImGetDirQuadrantFromDelta  or function(i1, i2)
    jit.off(true)
    local out = C.igImGetDirQuadrantFromDelta(i1, i2)
    return out
end
...
M.ImTextCharFromUtf8 = M.ImTextCharFromUtf8  or function(i1, i2)
    jit.off(true)
    local o1 = ffi.new("unsigned int[1]")
    local out = C.igImTextCharFromUtf8(o1, i1, i2)
    return o1[0], out
end
M.ImTextCharToUtf8 = M.ImTextCharToUtf8  or function(i1)
    jit.off(true)
    local o1 = ffi.new("char[5][1]")
    local out = C.igImTextCharToUtf8(o1, i1)
    return o1[0], out
end
...
M.ImTextStrFromUtf8 = M.ImTextStrFromUtf8  or function(i1, i2, i3)
    jit.off(true)
    local o1 = ffi.new("ImWchar[1]")
    local o2 = ffi.new("int[1]")
    local out = C.igImTextStrFromUtf8(o1, o2, i1, i2, i3)
    return o1[0], o2[0], out
end
M.ImTextStrToUtf8 = M.ImTextStrToUtf8  or function(i1, i2)
    jit.off(true)
    local o1 = ffi.new("char[1]")
    local o2 = ffi.new("int[1]")
    local out = C.igImTextStrToUtf8(o1, o2, i1, i2)
    return o1[0], o2[0], out
end
...
M.Initialize = M.Initialize  or function(i1)
    jit.off(true)
    local out = C.igInitialize(i1)
    return out
end
...
M.IsActiveIdUsingKey = M.IsActiveIdUsingKey  or function(i1)
    jit.off(true)
    local out = C.igIsActiveIdUsingKey(i1)
    return out
end
...
M.IsActiveIdUsingNavInput = M.IsActiveIdUsingNavInput  or function(i1)
    jit.off(true)
    local out = C.igIsActiveIdUsingNavInput(i1)
    return out
end
...
M.IsKeyPressedMap = M.IsKeyPressedMap  or function(i1, i2)
    jit.off(true)
    if i2 == nil then i2 = true end
    local out = C.igIsKeyPressedMap(i1, i2)
    return out
end
...
M.IsNavInputDown = M.IsNavInputDown  or function(i1)
    jit.off(true)
    local out = C.igIsNavInputDown(i1)
    return out
end
M.IsNavInputTest = M.IsNavInputTest  or function(i1, i2)
    jit.off(true)
    local out = C.igIsNavInputTest(i1, i2)
    return out
end
...
M.ItemHoverable = M.ItemHoverable  or function(i1, i2)
    jit.off(true)
    local out = C.igItemHoverable(i1, i2)
    return out
end
...
M.RenderMouseCursor = M.RenderMouseCursor  or function(i1, i2, i3, i4, i5, i6, i7)
    jit.off(true)
    local out = C.igRenderMouseCursor(i1, i2, i3, i4, i5, i6, i7)
    return out
end
...
M.SeparatorEx = M.SeparatorEx  or function(i1)
    jit.off(true)
    local out = C.igSeparatorEx(i1)
    return out
end
...
M.SetActiveIdUsingKey = M.SetActiveIdUsingKey  or function(i1)
    jit.off(true)
    local out = C.igSetActiveIdUsingKey(i1)
    return out
end
M.SetActiveIdUsingNavAndKeys = M.SetActiveIdUsingNavAndKeys  or function()
    jit.off(true)
    local out = C.igSetActiveIdUsingNavAndKeys()
    return out
end
...
M.SetItemUsingMouseWheel = M.SetItemUsingMouseWheel  or function()
    jit.off(true)
    local out = C.igSetItemUsingMouseWheel()
    return out
end
...
M.Shutdown = M.Shutdown  or function(i1)
    jit.off(true)
    local out = C.igShutdown(i1)
    return out
end
...
M.SliderBehavior = M.SliderBehavior  or function(i1, i2, i3, i4, i5, i6, i7, i8)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.igSliderBehavior(i1, i2, i3, i4, i5, i6, i7, i8, o1)
    return o1[0], out
end
...
M.TabItemCalcSize = M.TabItemCalcSize  or function(i1, i2)
    jit.off(true)
    local o1 = ffi.new("ImVec2[1]")
    local out = C.igTabItemCalcSize(o1, i1, i2)
    return o1[0], out
end
...
M.TabItemLabelAndCloseButton = M.TabItemLabelAndCloseButton  or function(i1, i2, i3, i4, i5, i6, i7, i8)
    jit.off(true)
    local o1 = ffi.new("bool[1]")
    local o2 = ffi.new("bool[1]")
    local out = C.igTabItemLabelAndCloseButton(i1, i2, i3, i4, i5, i6, i7, i8, o1, o2)
    return o1[0], o2[0], out
end
...
M.TableDrawContextMenu = M.TableDrawContextMenu  or function(i1)
    jit.off(true)
    local out = C.igTableDrawContextMenu(i1)
    return out
end
...
M.TableGetCellBgRect = M.TableGetCellBgRect  or function(i1, i2)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.igTableGetCellBgRect(o1, i1, i2)
    return o1[0], out
end
...
M.TableSettingsInstallHandler = M.TableSettingsInstallHandler  or function(i1)
    jit.off(true)
    local out = C.igTableSettingsInstallHandler(i1)
    return out
end
...
M.TreeNodeBehaviorIsOpen = M.TreeNodeBehaviorIsOpen  or function(i1, i2)
    jit.off(true)
    if i2 == nil then i2 = 0 end
    local out = C.igTreeNodeBehaviorIsOpen(i1, i2)
    return out
end
...
M.WindowRectAbsToRel = M.WindowRectAbsToRel  or function(i1, i2)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.igWindowRectAbsToRel(o1, i1, i2)
    return o1[0], out
end
M.WindowRectRelToAbs = M.WindowRectRelToAbs  or function(i1, i2)
    jit.off(true)
    local o1 = ffi.new("ImRect[1]")
    local out = C.igWindowRectRelToAbs(o1, i1, i2)
    return o1[0], out
end